...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    loading_details: "Loading connection…",
    connection_gone: "This connection is no longer being offered.",
    details_failed: "The connection could not be loaded.",
    close: "Close",
  ...
  de: {
    ...
    loading_details: "Verbindung wird geladen …",
    connection_gone: "Diese Verbindung wird nicht mehr angeboten.",
    details_failed: "Die Verbindung konnte nicht geladen werden.",
    close: "Schließen",
  ...
  fr: {
    ...
    loading_details: "Chargement de la correspondance…",
    connection_gone: "Cette correspondance n'est plus proposée.",
    details_failed: "Impossible de charger la correspondance.",
    close: "Fermer",
  ...
  nl: {
    ...
    loading_details: "Verbinding wordt geladen…",
    connection_gone: "Deze verbinding wordt niet meer aangeboden.",
    details_failed: "De verbinding kon niet worden geladen.",
    close: "Sluiten",
  ...
  sv: {
    ...
    loading_details: "Förbindelsen laddas …",
    connection_gone: "Den här förbindelsen erbjuds inte längre.",
    details_failed: "Förbindelsen kunde inte laddas.",
    close: "Stäng",
  ...
  pl: {
    ...
    loading_details: "Wczytywanie połączenia…",
    connection_gone: "To połączenie nie jest już oferowane.",
    details_failed: "Nie udało się wczytać połączenia.",
    close: "Zamknij",
  ...
  it: {
    ...
    loading_details: "Caricamento della coincidenza…",
    connection_gone: "Questa coincidenza non è più offerta.",
    details_failed: "Impossibile caricare la coincidenza.",
    close: "Chiudi",
